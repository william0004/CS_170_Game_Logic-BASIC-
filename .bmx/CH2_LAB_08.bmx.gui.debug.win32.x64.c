#include "CH2_LAB_08.bmx.gui.debug.win32.x64.h"
...
static BBString _s11={
	...
	0x5fcccd755c511b3b,
	46,
	{69,110,116,101,114,32,90,90,32,116,111,32,115,97,121,32,72
	,101,108,108,111,44,32,111,114,32,71,71,32,116,111,32,115
	,97,121,32,71,111,111,100,98,121,101,32,47,110}
};
...
static BBString _s15={
	...
	0x7dff5e791c6981b1,
	9,
	{71,111,111,100,98,121,101,33,32}
};
static BBString _s13={
	&bbStringClass,
	0x7c71a5b0e765fc6d,
	7,
	{72,101,108,108,111,33,32}
};
static BBString _s16={
	&bbStringClass,
	0x4d2a3cc330b50723,
	22,
	{83,111,114,114,121,44,32,105,108,108,101,103,97,108,32,105,110
	,112,117,116,46,32}
};
static BBString _s2={
	&bbStringClass,
...
BBSTRING _m_CH2_LAB_08_info411=(&bbEmptyString);
static int _bb_main_inited = 0;
int _bb_main(){
	if (!_bb_main_inited) {
		_bb_main_inited = 1;
		GC_add_roots(&_m_CH2_LAB_08_info411, &_m_CH2_LAB_08_info411 + 1);
		...
		bbRegisterSource(0xb4695ac340ddba70, "I:/study/CS 170/lab/CH2_LAB_08.bmx");
			...
			{
				{
					...
					"info411",
					"$",
					.var_address=(void*)&_m_CH2_LAB_08_info411
				},
				BBDEBUGDECL_END 
			}
		};
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0xb4695ac340ddba70, 7, 0};
		bbOnDebugEnterStm(&__stmt_0);
		_m_CH2_LAB_08_info411=brl_standardio_Input(&_s11);
		struct BBDebugStm __stmt_1 = {0xb4695ac340ddba70, 8, 0};
		bbOnDebugEnterStm(&__stmt_1);
		BBSTRING bbt_=_m_CH2_LAB_08_info411;
		struct BBDebugStm __stmt_2 = {0xb4695ac340ddba70, 9, 0};
		...
		if(bbStringEquals(bbt_, &_s12)==1){
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0xb4695ac340ddba70, 10, 0};
			bbOnDebugEnterStm(&__stmt_0);
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0xb4695ac340ddba70, 11, 0};
			bbOnDebugEnterStm(&__stmt_0);
			if(bbStringEquals(bbt_, &_s14)==1){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0xb4695ac340ddba70, 12, 0};
				bbOnDebugEnterStm(&__stmt_0);
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0xb4695ac340ddba70, 14, 0};
				bbOnDebugEnterStm(&__stmt_0);
				brl_standardio_Print(&_s16);
				bbOnDebugLeaveScope();
			}
			bbOnDebugLeaveScope();
		}

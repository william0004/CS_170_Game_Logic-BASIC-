#include "Class work Create window.bmx.gui.debug.win32.x64.h"
...
int _bb_main(){
	if (!_bb_main_inited) {
		...
		bbRegisterSource(0x22a71e7ee3c6f78c, "I:/study/CS 170/lab/Class work Create window.bmx");
		...
		struct BBDebugScope __scope = {
			...
			"Class work Create window",
			{
				BBDEBUGDECL_END 
			}
		};
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x22a71e7ee3c6f78c, 8, 0};
		bbOnDebugEnterStm(&__stmt_0);
		brl_graphics_Graphics(800,640,0,60,0,-1,-1);
		struct BBDebugStm __stmt_1 = {0x22a71e7ee3c6f78c, 9, 0};
		bbOnDebugEnterStm(&__stmt_1);
		brl_max2d_DrawText(&_s11,400.000000f,320.000000f);
		struct BBDebugStm __stmt_2 = {0x22a71e7ee3c6f78c, 12, 0};

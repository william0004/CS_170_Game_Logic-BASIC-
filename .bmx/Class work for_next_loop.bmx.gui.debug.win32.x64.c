#include "Class work for_next_loop.bmx.gui.debug.win32.x64.h"
...
BBINT _m_Class_work_for_next_loop_count=0;
BBFLOAT _m_Class_work_for_next_loop_num=.00000000f;
static int _bb_main_inited = 0;
int _bb_main(){
	if (!_bb_main_inited) {
		_bb_main_inited = 1;
		GC_add_roots(&_m_Class_work_for_next_loop_count, &_m_Class_work_for_next_loop_num + 1);
		...
		bbRegisterSource(0x90c3fa0b2caecb9f, "G:/study/CS 170/lab/Class work for_next_loop.bmx");
		struct BBDebugScope_2 __scope = {
			BBDEBUGSCOPE_FUNCTION,
			"Class work for_next_loop",
			{
				{
					BBDEBUGDECL_GLOBAL,
					"count",
					"i",
					.var_address=(void*)&_m_Class_work_for_next_loop_count
				},
				{
					BBDEBUGDECL_GLOBAL,
					"num",
					"f",
					.var_address=(void*)&_m_Class_work_for_next_loop_num
				},
				BBDEBUGDECL_END 
			}
		};
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x90c3fa0b2caecb9f, 7, 0};
		bbOnDebugEnterStm(&__stmt_0);
		struct BBDebugStm __stmt_1 = {0x90c3fa0b2caecb9f, 9, 0};
		bbOnDebugEnterStm(&__stmt_1);
		for(_m_Class_work_for_next_loop_count=0;(_m_Class_work_for_next_loop_count<=10);_m_Class_work_for_next_loop_count=(_m_Class_work_for_next_loop_count+1)){
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0x90c3fa0b2caecb9f, 10, 0};
			bbOnDebugEnterStm(&__stmt_0);
			brl_standardio_Print(bbStringFromInt(_m_Class_work_for_next_loop_count));
			bbOnDebugLeaveScope();
		}
		struct BBDebugStm __stmt_2 = {0x90c3fa0b2caecb9f, 13, 0};
		bbOnDebugEnterStm(&__stmt_2);
		brl_standardio_Print(&bbEmptyString);
		struct BBDebugStm __stmt_3 = {0x90c3fa0b2caecb9f, 14, 0};
		bbOnDebugEnterStm(&__stmt_3);
		brl_standardio_Print(&bbEmptyString);
		struct BBDebugStm __stmt_4 = {0x90c3fa0b2caecb9f, 15, 0};
		bbOnDebugEnterStm(&__stmt_4);
		brl_standardio_Print(&bbEmptyString);
		struct BBDebugStm __stmt_5 = {0x90c3fa0b2caecb9f, 17, 0};
		bbOnDebugEnterStm(&__stmt_5);
		struct BBDebugStm __stmt_6 = {0x90c3fa0b2caecb9f, 18, 0};
		bbOnDebugEnterStm(&__stmt_6);
		for(_m_Class_work_for_next_loop_num=10.0000000f;(_m_Class_work_for_next_loop_num>=0.000000000f);_m_Class_work_for_next_loop_num=(_m_Class_work_for_next_loop_num+-0.7f)){
			struct BBDebugScope __scope = {
				BBDEBUGSCOPE_LOCALBLOCK,
				0,
				{
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0x90c3fa0b2caecb9f, 19, 0};
			bbOnDebugEnterStm(&__stmt_0);
			brl_standardio_Print(bbStringFromFloat(_m_Class_work_for_next_loop_num));
			bbOnDebugLeaveScope();
		}
		bbOnDebugLeaveScope();
		return 0;

#include "Class work function.bmx.gui.debug.win32.x64.h"
static BBString _s14={
	&bbStringClass,
	0xa2be22f4a9159381,
	22,
	{9,9,9,9,9,68,111,110,101,32,119,105,116,104,32,112,114
	,111,103,114,97,109}
};
static BBString _s13={
	...
	0x83d52575f4b58f31,
	39,
	{9,9,9,9,9,69,110,116,101,114,32,49,32,116,111,32,82
	,101,112,101,97,116,44,32,111,114,32,55,32,116,111,32,69
	,120,105,116,46,32,32}
};
static BBString _s15={
	&bbStringClass,
	0x87e72db16073756,
	14,
	{9,9,9,9,9,87,104,97,116,63,63,63,33,33}
};
static BBString _s12={
	&bbStringClass,
	0xc0b5486ad70c42ca,
	27,
	{9,9,9,9,9,89,111,117,114,32,102,117,108,108,32,110,97
	,109,101,32,104,101,114,101,58,32,32}
};
...
BBSTRING _m_Class_work_function_fullName=&_s11;
BBINT _m_Class_work_function_getINFO=0;
BBINT _m_Class_work_function_repeat_it(){
	...
	struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 17, 0};
	bbOnDebugEnterStm(&__stmt_0);
	brl_standardio_Print(&bbEmptyString);
	struct BBDebugStm __stmt_1 = {0x46aecc74c9330697, 18, 0};
	bbOnDebugEnterStm(&__stmt_1);
	_m_Class_work_function_getINFO=bbStringToInt(brl_standardio_Input(&_s13));
	struct BBDebugStm __stmt_2 = {0x46aecc74c9330697, 19, 0};
	bbOnDebugEnterStm(&__stmt_2);
	brl_standardio_Print(&bbEmptyString);
	struct BBDebugStm __stmt_3 = {0x46aecc74c9330697, 21, 0};
	bbOnDebugEnterStm(&__stmt_3);
	BBINT bbt_=_m_Class_work_function_getINFO;
	struct BBDebugStm __stmt_4 = {0x46aecc74c9330697, 22, 0};
	...
	if(bbt_==1){
		...
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 23, 0};
		bbOnDebugEnterStm(&__stmt_0);
		_m_Class_work_function_repeat_it();
		bbOnDebugLeaveScope();
	}else{
		struct BBDebugScope __scope = {
			BBDEBUGSCOPE_LOCALBLOCK,
		...
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 24, 0};
		bbOnDebugEnterStm(&__stmt_0);
		if(bbt_==7){
			struct BBDebugScope __scope = {
				BBDEBUGSCOPE_LOCALBLOCK,
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 25, 0};
			bbOnDebugEnterStm(&__stmt_0);
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 27, 0};
			bbOnDebugEnterStm(&__stmt_0);
...
int _bb_main(){
	if (!_bb_main_inited) {
		_bb_main_inited = 1;
		GC_add_roots(&_m_Class_work_function_fullName, &_m_Class_work_function_getINFO + 1);
		...
		bbRegisterSource(0x46aecc74c9330697, "I:/study/CS 170/lab/Class work function.bmx");
			...
			{
				{
					...
					"fullName",
					"$",
					.var_address=(void*)&_m_Class_work_function_fullName
				},
				{
					BBDEBUGDECL_GLOBAL,
					"getINFO",
					"i",
					.var_address=(void*)&_m_Class_work_function_getINFO
				},
				BBDEBUGDECL_END 
			}
		};
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x46aecc74c9330697, 7, 0};
		bbOnDebugEnterStm(&__stmt_0);
		struct BBDebugStm __stmt_1 = {0x46aecc74c9330697, 8, 0};
		bbOnDebugEnterStm(&__stmt_1);
		struct BBDebugStm __stmt_2 = {0x46aecc74c9330697, 9, 0};
		bbOnDebugEnterStm(&__stmt_2);
		brl_standardio_Print(&bbEmptyString);
		struct BBDebugStm __stmt_3 = {0x46aecc74c9330697, 10, 0};
		bbOnDebugEnterStm(&__stmt_3);
		brl_standardio_Print(&bbEmptyString);
		struct BBDebugStm __stmt_4 = {0x46aecc74c9330697, 12, 0};
		bbOnDebugEnterStm(&__stmt_4);
		_m_Class_work_function_fullName=brl_standardio_Input(&_s12);
		struct BBDebugStm __stmt_5 = {0x46aecc74c9330697, 14, 0};

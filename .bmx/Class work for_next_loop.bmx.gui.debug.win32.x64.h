#ifndef LAB_CLASS_WORK_FOR_NEXT_LOOP_BMX_GUI_DEBUG_WIN32_X64_H
#define LAB_CLASS_WORK_FOR_NEXT_LOOP_BMX_GUI_DEBUG_WIN32_X64_H
...
int _bb_main();
extern BBINT _m_Class_work_for_next_loop_count;
extern BBFLOAT _m_Class_work_for_next_loop_num;

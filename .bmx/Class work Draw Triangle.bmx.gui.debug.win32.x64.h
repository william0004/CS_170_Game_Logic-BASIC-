#ifndef LAB_CLASS_WORK_DRAW_TRIANGLE_BMX_GUI_DEBUG_WIN32_X64_H
#define LAB_CLASS_WORK_DRAW_TRIANGLE_BMX_GUI_DEBUG_WIN32_X64_H
...
int _bb_main();
struct _m_Class_work_Draw_Triangle_TPoint_obj;
void __m_Class_work_Draw_Triangle_TPoint_New(struct _m_Class_work_Draw_Triangle_TPoint_obj* o);
struct BBClass__m_Class_work_Draw_Triangle_TPoint {
	BBClass*  super;
...
struct _m_Class_work_Draw_Triangle_TPoint_obj {
	struct BBClass__m_Class_work_Draw_Triangle_TPoint* clas;
	BBINT __m_class_work_draw_triangle_tpoint_x;
	BBINT __m_class_work_draw_triangle_tpoint_y;
};
extern struct BBClass__m_Class_work_Draw_Triangle_TPoint _m_Class_work_Draw_Triangle_TPoint;
extern struct _m_Class_work_Draw_Triangle_TPoint_obj* _m_Class_work_Draw_Triangle_point1;
extern struct _m_Class_work_Draw_Triangle_TPoint_obj* _m_Class_work_Draw_Triangle_point2;
extern struct _m_Class_work_Draw_Triangle_TPoint_obj* _m_Class_work_Draw_Triangle_point3;

#ifndef LAB_CLASS_WORK_WHILE_WEND_LOOP_BMX_GUI_DEBUG_WIN32_X64_H
#define LAB_CLASS_WORK_WHILE_WEND_LOOP_BMX_GUI_DEBUG_WIN32_X64_H
...
int _bb_main();
extern BBINT _m_Class_work_While_Wend_Loop_y;

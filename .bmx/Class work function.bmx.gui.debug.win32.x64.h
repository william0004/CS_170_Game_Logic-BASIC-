#ifndef LAB_CLASS_WORK_FUNCTION_BMX_GUI_DEBUG_WIN32_X64_H
#define LAB_CLASS_WORK_FUNCTION_BMX_GUI_DEBUG_WIN32_X64_H
...
int _bb_main();
extern BBSTRING _m_Class_work_function_fullName;
extern BBINT _m_Class_work_function_getINFO;
